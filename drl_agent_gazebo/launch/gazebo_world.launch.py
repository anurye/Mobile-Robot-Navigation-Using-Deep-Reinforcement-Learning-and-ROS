...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('world_path',
          default_value=[os.path.join(get_package_share_directory('drl_agent_gazebo'), 'worlds', 'td7_static.world')],
...
def generate_launch_description():
    ...
    *************************************************************************************"""
    ...
    drl_agent_gazebo_package_directory = get_package_share_directory(drl_agent_gazebo_package_name)
    ...
    *************************************************************************************"""
    drl_agent_gazebo_install_dir_path = (get_package_prefix(drl_agent_gazebo_package_name) + '/share')
    ...
    drl_agent_gazebo_models_path = os.path.join(drl_agent_gazebo_package_directory, 'models')
    
    gazebo_resource_paths = [drl_agent_gazebo_install_dir_path, drl_agent_install_dir_path, robot_meshes_path, drl_agent_description_models_path,\
                             drl_agent_gazebo_models_path, velodyne_description_install_dir_path, velodyne_description_meshes_path]
